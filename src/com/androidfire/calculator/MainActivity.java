package com.androidfire.calculator;
...
public class MainActivity extends Activity implements OnClickListener {
    ...
    private RobinBrain mRobinBrain;
    ...
    public void onClick(View v) {
        ...
        if (DIGITS.contains(buttonPressed)) {
            ...
            if (userIsInTheMiddleOfTypingANumber) {
                ...
                mRobinBrain.setOperand(Double.parseDouble(mCalculatorDisplay.getText().toString()));
                userIsInTheMiddleOfTypingANumber = false;
            }
 
            mRobinBrain.performOperation(buttonPressed);
            mCalculatorDisplay.setText(df.format(mRobinBrain.getResult()));
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putDouble("OPERAND",mRobinBrain.getResult());
        outState.putDouble("MEMORY", mRobinBrain.getMemory());
    }
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        mRobinBrain.setOperand(savedInstanceState.getDouble("OPERAND"));
        mRobinBrain.setMemory(savedInstanceState.getDouble("MEMORY"));
        mCalculatorDisplay.setText(df.format(mRobinBrain.getResult()));
    }
